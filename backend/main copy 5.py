...
def puntos_control(
    ...
    for shape in shapes:
        ...
        def dist(p1, p2):
            ...
            return R * 2 * atan2(sqrt(a), sqrt(1 - a))
        d_inicio_fin = dist(inicio, fin)
        if d_inicio_fin < distancia_unificacion:
            # Shape cerrado: GGX (en el medio) y dos GZInt a 1/3 y 2/3
            mid = {
    ...
    # Agregar los intermedios (GZInt) sin agrupar
    puntos_finales.extend(puntos_intermedios)
