...
class PerfilEspecial(Base):
    ...
    id_usuario_verif = Column(Integer, ForeignKey('sistema.usuarios.id'), nullable=True)
    id_usuario_aprob = Column(Integer, ForeignKey('sistema.usuarios.id'), nullable=True)
    ip_origen = Column(String(45), nullable=True)
    user_agent = Column(Text, nullable=True)
    device_id = Column(String(255), nullable=True)
    ip_aprobo = Column(String(45), nullable=True)
    device_id_aprobo = Column(String(255), nullable=True)
    ...
    usuario_verif = relationship("Usuario", foreign_keys=[id_usuario_verif])
